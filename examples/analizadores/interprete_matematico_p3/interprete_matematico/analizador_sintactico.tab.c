...
#line 113 "bison/analizador_sintactico.y"
			...
			yyerrok; }
#line 1532 "analizador_sintactico.tab.c"
    break;
...
#line 1542 "analizador_sintactico.tab.c"
    break;

  case 10: /* instr: comm pyc  */
#line 133 "bison/analizador_sintactico.y"
                 { (yyval.num) = (yyvsp[-1].num); }
#line 1548 "analizador_sintactico.tab.c"
    break;

  case 11: /* instr: comm  */
#line 134 "bison/analizador_sintactico.y"
                       { (yyval.num) = (yyvsp[0].num); }
#line 1554 "analizador_sintactico.tab.c"
    break;
...
#line 144 "bison/analizador_sintactico.y"
           { /* Cancelamos impresión pues es una función*/
			 ce.print_out = FALSE; }
#line 1573 "analizador_sintactico.tab.c"
    break;

  case 17: /* comm: exp_asg  */
#line 146 "bison/analizador_sintactico.y"
                          { (yyval.num) = (yyvsp[0].num); }
#line 1579 "analizador_sintactico.tab.c"
    break;
...
#line 1728 "analizador_sintactico.tab.c"
    break;
...
#line 280 "bison/analizador_sintactico.y"
                      { (yyval.num) = (yyvsp[0].num); }
#line 1746 "analizador_sintactico.tab.c"
    break;

  case 28: /* exp: exp '+' exp  */
#line 282 "bison/analizador_sintactico.y"
                              { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1752 "analizador_sintactico.tab.c"
    break;
...
#line 284 "bison/analizador_sintactico.y"
                              { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1764 "analizador_sintactico.tab.c"
    break;
...
#line 1782 "analizador_sintactico.tab.c"
    break;
...
#line 1824 "analizador_sintactico.tab.c"
    break;
...
#line 1842 "analizador_sintactico.tab.c"
    break;
...
#line 1850 "analizador_sintactico.tab.c"
    break;
...
#line 353 "bison/analizador_sintactico.y"
                            { (yyval.num) = ((yyvsp[-2].cmplx)->datos.di.valor += (yyvsp[0].num)); }
#line 1874 "analizador_sintactico.tab.c"
    break;
...
#line 355 "bison/analizador_sintactico.y"
                                      { (yyval.num) = ((yyvsp[-2].cmplx)->datos.di.valor *= (yyvsp[0].num)); }
#line 1886 "analizador_sintactico.tab.c"
    break;

  case 43: /* asign_op: DIV_EQ exp  */
#line 356 "bison/analizador_sintactico.y"
                                     { (yyval.num) = ((yyvsp[-2].cmplx)->datos.di.valor /= (yyvsp[0].num)); }
#line 1892 "analizador_sintactico.tab.c"
    break;
...
#line 1898 "analizador_sintactico.tab.c"
    break;
...
#line 1904 "analizador_sintactico.tab.c"
    break;

  case 46: /* storage: IDENTIFICADOR  */
#line 363 "bison/analizador_sintactico.y"
                                      { (yyval.cmplx) = (yyvsp[0].cmplx); }
#line 1910 "analizador_sintactico.tab.c"
    break;
